...
public class IceepeeceeContest {
    ...
    /**
     * Obtiene el ángulo mínimo calculado por el último llamado a "simulate".
     *
     * @return El ángulo mínimo en grados.
     */
     ...
     * @throws IceepeeceeException If an exception related to Iceepeecee operations occurs.
     */
    public static void simulate(int[][][] islands, int[][][] flights)  {
     ...
     */
    public static boolean isOperationSuccess() {
        return operationOk;
    }
}
